...
import com.nari.somnium.connection.*;
...
public class HttpUrlConnectionRequest implements HttpRequest {
	private final Logger log = LoggerFactory.getLogger(HttpUrlConnectionRequest.class);
	
    private static final String TAG = "thirdlove";
    private static final int DEFAULT_TIMEOUT = 60000;
    private Proxy proxy = Proxy.NO_PROXY;
    private int timeout = DEFAULT_TIMEOUT;
    private String contentType;

    private HttpRequestResponseHandler handler = new HttpRequestResponseHandler();
    ...
    @Override
    public HttpRequest handler(HttpRequestResponseHandler handler) {
    ...
    private Class findType(HttpRequestResponseHandler handler) {
